...
# This script recursively searches for "/home/*/.vscode-server/bin" folders under the current directory. Under the found folders, the script will keep the latest vscode-server binary folder and delete the others.
